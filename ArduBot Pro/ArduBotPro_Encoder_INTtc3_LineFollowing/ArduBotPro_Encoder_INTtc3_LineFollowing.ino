...
//      digitalWrite(LED_L, OFF);
//      Motor_control(1000,1000);
      if (cCount==1000) Motor_control(1000,1000);
      else if (cCount==1800) Motor_control(0,0);
      readAllIR_values();
      IR_Max_Min();
//      CHECK_IRvariables();
      break;
...
void AdcBooster()
{
  ...
  ADC->CTRLB.reg = ADC_CTRLB_PRESCALER_DIV64 |    // Divide Clock by 64, ~31us per ADC sample
